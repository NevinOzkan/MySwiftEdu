...
//Bands
let dedüblüman = FavoriteElements(name: "Dedüblüman", imagename: "dedüblüman", description: "No 1 Music Band")
...
let favoriteBands = FavoriteModel(title: "Favorite Bands", elements: [dedüblüman,megadeth,ironmaiden])
